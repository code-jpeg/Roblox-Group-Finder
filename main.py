...
#your webhook
hook = input("[-] Enter your webhook url: https://discord.com/api/webhooks/1016245363377721375/4P0yuBV9Eq1QwieoxKLdMvi7QYJbpXMV0B3q4sXWJN5N73OHPiBohp1yAqzdIYcNIOgP "))
#number of threads
threads = int(input("[-] How many threads: 500 "))
